...
class select_constraints_box:
    ...
    def get_constraints_names(self):
        dirs = os.listdir(
            os.path.join(
                RESULTPATH,
                self.function_box.selected_objective,
                self.function_box.get_values_of_params(),
            )
        )
        return dirs
...
class main_window:
    def __init__(self) -> None:
        ...
        self.set_constraints_button = tk.Button(
            self.root, text="set constraints", command=self.set_constraints
        )
        self.select_constraints_frame = None
        self.set_solver_button = tk.Button(
            self.root, text="set solver", command=self.set_solver
        )
        self.notebook = None
        ...
        self.option_button = tk.Button(
            self.root, text="option", command=self.open_option
        )
        self.option_window = None
        self.option_entries = {}
        self.show_result_button = tk.Button(
            self.root, text="Show", command=self.show_result
        )
    ...
    def set_constraints(self):
        self.clear()
        self.select_constraints_frame = select_constraints_box(
            self.root, self.select_objective_frame
        )
    ...
    def open_option(self):
        self.option_window, self.option_entries = open_option_window(
            self.root, self.option_window, self.option_entries
        )
